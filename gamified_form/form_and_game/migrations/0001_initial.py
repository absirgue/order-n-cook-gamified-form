    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_city', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('methode_classement_commandes', models.CharField(choices=[('classeur', 'Classeur'), ('trieur', 'Trieur'), ('ordinateur', 'Ordinateur'), ('comptabilite', 'envoi\xa0à la comptabilité en direct'), ('non gardées', '(je ne les garde pas)'), ('Autre', 'Autre')], max_length=90)),
                ('methode_classement_bons_livraison', models.CharField(choices=[('classeur', 'Classeur'), ('trieur', 'Trieur'), ('ordinateur', 'Ordinateur'), ('comptabilite', 'envoi\xa0à la comptabilité en direct'), ('non gardées', '(je ne les garde pas)'), ('Autre', 'Autre')], max_length=90)),
                ('methode_classement_factures', models.CharField(choices=[('classeur', 'Classeur'), ('trieur', 'Trieur'), ('ordinateur', 'Ordinateur'), ('comptabilite', 'envoi\xa0à la comptabilité en direct'), ('non gardées', '(je ne les garde pas)'), ('Autre', 'Autre')], max_length=90)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('frequence_modification', models.CharField(choices=[('Tous les jours', 'Tous les jours'), ('Toutes les semaines', 'toutes les semaines'), ('Tous les mois', 'tous les mois'), ('Par saison', 'par saison'), ('Autre', 'Autres')], max_length=90)),
                ...
                ('prix_trouve_justes_clients', models.CharField(choices=[('Oui, suffisament juste', 'oui, suffisament juste'), ('Non', 'Non'), ('Pas sûr', 'pas sûr')], max_length=90)),
                ('prix_trouve_justes_soi', models.CharField(choices=[('Oui, suffisament juste', 'oui, suffisament juste'), ('Non', 'Non'), ('Pas sûr', 'pas sûr')], max_length=90)),
                ('player', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='form_and_game.player')),
            ],
        ),
    ]
